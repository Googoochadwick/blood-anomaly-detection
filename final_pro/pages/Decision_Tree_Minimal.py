...
MODEL_PATH = BASE_DIR / "bloodminimal.joblib"
...
st.image(str(BASE_DIR / "smsmax.png"), caption="Seaborn correlation heatmapped")
...
st.image(str(BASE_DIR / "caf.png"), caption="Call a friend from who wants to be a millionare")
...
st.image(str(BASE_DIR / "featimp.png"), caption="Feature Importance")
